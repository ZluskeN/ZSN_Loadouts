...
Fire support of artillery/mortar unit. Use where unit is local.
	...
	EXAMPLE 1: _bombardment = [BIS_Mortar,[3600,3600,0],"",100,24,10] execVM "FireSupport.sqf"
	EXAMPLE 2: _bombardment = [BIS_Mortar,BIS_Player,"8Rnd_82mm_Mo_shells",100,24,10] execVM "FireSupport.sqf"
	EXAMPLE 3: _bombardment = [BIS_Mortar,"BIS_mrkTargetArea","8Rnd_82mm_Mo_shells",100,24,10,{BIS_Player distance BIS_EscapeZone < 100}] execVM "FireSupport.sqf"
	EXAMPLE 4: _bombardment = [BIS_Mortar,BIS_Player,"8Rnd_82mm_Mo_shells",100,24,10,{dayTime > 20},50] execVM "FireSupport.sqf"
	EXAMPLE 5: _bombardment = [BIS_Mortar,BIS_Victim,"8Rnd_82mm_Mo_shells",100,24,[5,10],{dayTime > 20},50] execVM "FireSupport.sqf"
*/
