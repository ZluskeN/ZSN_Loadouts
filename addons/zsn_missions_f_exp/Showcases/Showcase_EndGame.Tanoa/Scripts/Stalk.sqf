...
If the optional condition is activated, you can either:
	...
	EXAMPLE 1: _stalk = [BIS_grpStalkers,BIS_grpPlayer] execVM "Stalk.sqf"
	EXAMPLE 2: _stalk = [BIS_grpStalkers,BIS_grpPlayer,nil,nil,{BIS_player distance BIS_Heli < 100},"BIS_mrkRetreatMarker"] execVM "Stalk.sqf"
	EXAMPLE 3: _stalk = [BIS_grpStalkers,BIS_grpPlayer,20,10,{BIS_Return},1] execVM "Stalk.sqf"
	EXAMPLE 4: _stalk = [BIS_grpStalkers,BIS_grpPlayer,5,0,{dayTime > 20},[3600,600,0]] execVM "Stalk.sqf"
*/
